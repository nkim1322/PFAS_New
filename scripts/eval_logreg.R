...
ivs <- list(PFOA = c("recharge","ImpactPr2","sandvc_r","sandvf_r","silttotal_r", "siltfine_r" ,
                     "claytotal_r" ,"dbthirdbar_r", "awc_r", "slopegradwta" , "bedrock_M" ,
                     "hydgrpdcdB" , "hydgrpdcdC"),
            PFHXA = c("ImpactOI2","ImpactPl2","ImpactAW2","ImpactPr2","ImpactS2","sandvc_r",
                      "siltfine_r","claytotal_r","brockdepmin","bedrock_M"),
            PFPEA = c( "ImpactPl2","ImpactAW2","ImpactPr2","ImpactT2","sandvc_r", "sandvf_r",
                       "silttotal_r","siltfine_r","dbthirdbar_r", "soc0_999","bedrock_M",
                       "drclassdcdW","drclassdcdP","hydgrpdcdC"),
            PFHPA = c("precip","recharge","ImpactOI2","ImpactPl2","ImpactPr2","sandvc_r",
                      "awc_r","brockdepmin", "hzdep","bedrock_M","drclassdcdW","drclassdcdP",
                      "hydgrpdcdC"),
            PFOS = c("precip","recharge","ImpactPl2","ImpactAW2","ImpactPr2", "sandvc_r",
                     "silttotal_r","siltfine_r","dbthirdbar_r", "awc_r", "slopegradwta",
                     "hzdep","drclassdcdW", "drclassdcdP","hydgrpdcdB","hydgrpdcdC"))
